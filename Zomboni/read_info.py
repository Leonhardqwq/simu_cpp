...
config_name = 'zomboni_config.json'

def build_config(excel_path=file_name):
...
def write_config(config_dict, json_path=config_name):
    with open(json_path, "w", encoding="utf-8") as f:
        json.dump(config_dict, f, ensure_ascii=False, indent=2)

def main():
    write_config(build_config(file_name), config_name)
